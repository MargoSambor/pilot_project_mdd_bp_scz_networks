...
#save SIF
write_tsv(sif, paste0(path, tag,"omnipath_carnival_sorted_curation_efford_10_pandoc.tsv"))
...
saveRDS(carnival_result, paste0(path, tag,"carnival_result_sorted_curation_efford_10_pandoc.rds"))
...
#visNet
visSave(visNet, file = paste0(path, tag,'carnival_visualization_visNetwork_sorted_curation_efford_10_pandoc.html'), selfcontained = TRUE)