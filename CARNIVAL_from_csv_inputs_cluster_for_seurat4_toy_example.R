...
#Run CARNIVAL
#Import datasets: 
tf_activities <- read_csv(paste0(path, tag, "dorothea_TFActivity_CARNIVALinput_toy_example.csv"))
...
#save SIF
write_tsv(sif, paste0(path, tag,"omnipath_carnival_toy_example.tsv"))
...
saveRDS(carnival_result, paste0(path, tag,"carnival_result_toy_example.rds"))
...
#visNet
visSave(visNet, file = paste0(path, tag,'carnival_visualization_visNetwork_toy_example.html'), selfcontained = TRUE)