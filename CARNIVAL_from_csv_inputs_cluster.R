...
source("/nfs/research/petsalaki/users/sambor/M_nAcc/assignPROGENyScores.r")
source("/nfs/research/petsalaki/users/sambor/M_nAcc/generateTFList.r")
source("/nfs/research/petsalaki/users/sambor/M_nAcc/carnival_visNetwork.r")
...
source("/nfs/research/petsalaki/users/sambor/M_nAcc/support_functions.R")
...
path=paste0("/nfs/research/petsalaki/users/sambor/", sex_brain_region, "/", sep="", collapse=NULL)
