...
# curation effort
omnipath_sd <- omnipath_sd %>% dplyr::filter(curation_effort > 10)
...
#save SIF
write_tsv(sif, paste0(path, tag,"omnipath_carnival_sorted_curation_efford_10_top25TFs_bottom25TFs.tsv"))
...
saveRDS(carnival_result, paste0(path, tag,"carnival_result_sorted_curation_efford_10_top25TFs_bottom25TFs.rds"))
...
#visNet
visSave(visNet, file = paste0(path, tag,'carnival_visualization_visNetwork_sorted_curation_efford_10_top25TFs_bottom25TFs.html'), selfcontained = TRUE)