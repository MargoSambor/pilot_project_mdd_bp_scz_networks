...
#save SIF
write_tsv(sif, paste0(path, tag,"omnipath_carnival_with_weights.tsv"))
...
saveRDS(carnival_result, paste0(path, tag,"carnival_result_with_weights.rds"))
...
#visNet
visSave(visNet, file = paste0(path, tag,'carnival_visualization_visNetwork_with_weights.html'), selfcontained = TRUE)