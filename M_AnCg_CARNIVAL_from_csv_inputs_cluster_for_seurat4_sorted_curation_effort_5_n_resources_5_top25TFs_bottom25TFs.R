...
#Run CARNIVAL
#Import datasets: 
tf_activities <- read_csv(paste0(path, tag, "dorothea_TFActivity_CARNIVALinput_top25_bottom25.csv"))
...
#save SIF
write_tsv(sif, paste0(path, tag,"omnipath_carnival_sorted_curation_efford_5_n_resources_5_top25TFs_bottom25TFs.tsv"))
...
saveRDS(carnival_result, paste0(path, tag,"carnival_result_sorted_curation_efford_5_n_resources_5_top25TFs_bottom25TFs.rds"))
...
#visNet
visSave(visNet, file = paste0(path, tag,'carnival_visualization_visNetwork_sorted_curation_efford_5_n_resources_5_top25TFs_bottom25TFs.html'), selfcontained = TRUE)