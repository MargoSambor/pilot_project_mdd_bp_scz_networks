...
#save SIF
write_tsv(sif, paste0(path, tag,"omnipath_carnival_cplex.tsv"))
...
saveRDS(carnival_result, paste0(path, tag,"carnival_result_cplex.rds"))
...
#visNet
visSave(visNet, file = paste0(path, tag,'carnival_visualization_visNetwork_cplex.html'), selfcontained = TRUE)