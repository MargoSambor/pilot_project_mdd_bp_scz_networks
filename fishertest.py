...
import sys
def load(protein_list,threshold,component,path_def,starting_proteins,pagerank,uniprot_to_gene,background):
	protein=protein_list
	path="'/nfs/research/petsalaki/shared_folder/diffusion/data/"+background+"/"
	temp={}
	for ii in component:
		descr={}
		temp[ii]=[]
