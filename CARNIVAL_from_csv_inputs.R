...
source("/home/sambor/Desktop/pilot_project/assignPROGENyScores.r")
source("/home/sambor/Desktop/pilot_project/generateTFList.r")
source("/home/sambor/Desktop/pilot_project/carnival_visNetwork.r")
...
source("/home/sambor/Desktop/pilot_project/support_functions.R")
...
path=paste0("/home/sambor/Desktop/pilot_project/results/correct/omit_depression_split_by_gender/", sex_brain_region, "/", sep="", collapse=NULL)
...
#save SIF
write_tsv(sif, paste0(path, tag,"omnipath_carnival.tsv"))
...
saveRDS(carnival_result, paste0(path, tag,"carnival_result.rds"))
...
#visNet
visSave(visNet, file = paste0(path, tag,'carnival_visualization_visNetwork.html'), selfcontained = TRUE)